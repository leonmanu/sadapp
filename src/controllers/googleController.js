import googleService from '../services/googleService.js'; // Solo importamos el default
...
    try {
        // Usamos googleService.getOAuth2Client
        const oAuth2Client = googleService.getOAuth2Client(req);
        
...
        const userProfile = await googleService.getGoogleProfile(oAuth2Client); // <-- CORRECTO
...
            files: files,
            googleUser: req.session.googleUser || null // <-- CORRECTO
        });
